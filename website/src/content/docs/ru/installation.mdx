...
<Aside type="caution">
Независимо от способа установки, вам необходимо прописать скрипт инициализации в конфигурацию вашей оболочки, чтобы команда `proxy on` могла изменять переменные окружения. См. [Интеграция с оболочкой](/Terminal-Session-Proxy-Manager/ru/shell-integration/).
</Aside>
...
[SHELL_INTEGRATION.ru.md](/Terminal-Session-Proxy-Manager/ru/shell-integration/).
