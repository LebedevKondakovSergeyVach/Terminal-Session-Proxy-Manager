---
title: '📦 Installation (macOS & Linux)'
...
<Aside type="caution">
However you installed it, add the init script to your shell configuration so `proxy on` can change your environment. See [Shell Integration](/Terminal-Session-Proxy-Manager/shell-integration/).
</Aside>
...
list of functions are in [SHELL_INTEGRATION.md](/Terminal-Session-Proxy-Manager/shell-integration/).
