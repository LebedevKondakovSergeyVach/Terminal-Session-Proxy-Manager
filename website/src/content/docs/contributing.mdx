...
[`.ai/GIT_WORKFLOW.md`](https://github.com/LebedevKondakovSergeyVach/Terminal-Session-Proxy-Manager/blob/main/.ai/GIT_WORKFLOW.md).
...
Point it at [`AGENTS.md`](https://github.com/LebedevKondakovSergeyVach/Terminal-Session-Proxy-Manager/blob/main/AGENTS.md) first; it encodes the rules above in the
form agents follow.
