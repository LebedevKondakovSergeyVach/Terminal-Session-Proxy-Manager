...
> [!WARNING]
> Каким бы способом вы ни установили утилиту, добавьте скрипт инициализации в
> конфигурацию вашей оболочки. Без этого команды `proxy` не будет, и ничто не
> сможет изменить окружение вашей сессии — процесс не может модифицировать
> оболочку-родителя.
