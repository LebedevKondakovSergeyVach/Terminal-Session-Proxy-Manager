# ==========================================================
# TERMINAL SESSION PROXY MANAGER — ZSH INTEGRATION
# ==========================================================
#
# Generated from: terminal-session-proxy-manager init zsh
#
...
# get that with `terminal-session-proxy-manager completions zsh`.
